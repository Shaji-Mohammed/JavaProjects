...
public class GameLogic {
    ...
    public static boolean squaresAreInvalid(int[][] grid) {
        if (rowsOfSquareAreInvalid(Rows.TOP, grid)) return true;

        if (rowsOfSquareAreInvalid(Rows.MIDDLE, grid)) return true;

        if (rowsOfSquareAreInvalid(Rows.BOTTOM, grid)) return true;
        
        return false;
    }

    public static boolean rowsOfSquareAreInvalid(Rows value, int[][] grid) {
        switch (value) {
            case TOP:
